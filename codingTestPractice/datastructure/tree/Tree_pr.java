...
public class Tree_pr {
    private String value;
    private ArrayList<Tree_pr> children;

    public Tree_pr() {	//전달인자가 없을 경우의 생성자
        this.value = null;
        this.children = null;
    }
    public Tree_pr(String data) {	//전달인자가 존재할 경우의 생성자
        this.value = data;
        this.children = null;
    }
    ...
    public void addChildNode(Tree_pr node) {
        if(children == null) children = new ArrayList<>();
        children.add(node);
    }
    public void removeChildNode(Tree_pr node) {
    ...
    public ArrayList<Tree_pr> getChildrenNode() {
        return children;
    }
